chrome.runtime.sendMessage({ message: "online.vfsglobal.dz-home" }, function (response) {
  //s
...
async function vfsHomePage(){
  await WaitForXpath("/html/body/div[2]/div[1]/div[2]/div/div/div[2]/div/ul/li[1]/a");
  _x("/html/body/div[2]/div[1]/div[2]/div/div/div[2]/div/ul/li[1]/a").click(); //Schedule appointment Button
